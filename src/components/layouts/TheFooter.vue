...
<script>
  ...
  export default {
      ...
      data() {
          return {
              description: 'Agility 是一个个人论坛',
              contacts: [
                  {
                      icon: 'envelope',
                      title: '反馈问题',
                      link: 'mailto:yushizhi@qq.com'
                  },
                  {
                      icon: 'weibo',
                      title: '站长微博',
                  ...
                  },
                  {
                      icon: 'weixin',
                      title: '加我微信',
                      link: 'https://agility.com/contact'
                  }
              ],
              contactStyle: {
                  paddingRight: '8px'
              ...
              <span style="font-size:0.9em">Designed by
                ...
                <a href="https://github.com/yushizhi"target="_blank"style="color:inherit">Agility</a>
              </span>
              `,
              sponsor: {
                  title: '赞助商',
                  ...
                  list: [
                      {
                          icon: 'thumbs-up',
                          title: '帮助',
                          link: 'http://agility.com/contact'
                      },
                      {
                          icon: 'globe',
                          title: '推荐网站',
                          link: 'http://agility.com/sites'
                      }
                  ]
              }
          }
...
<style scoped>
  a:hover, a:focus { color: #e27575; trasnsition: color .15s;}
</style>
